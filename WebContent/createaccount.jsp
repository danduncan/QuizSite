	...
	<div class="loginFrame">
		...
		<form method="post" action="CreateServlet" id="createform" >
			<span class="loginlabel" >Username </span>
				<input type="text" name="username" id="usernameBox" class="logintextbox" value="" onkeypress="if (event.keyCode==13) { event.preventDefault(); validateInputs(); }" />
			...
			<span class="loginlabel" >Name</span>
				<input type="text" name="firstname" id="firstNameBox" class="logintextbox shortloginbox" placeholder="First" value="" onkeypress="if (event.keyCode==13) { event.preventDefault(); validateInputs(); }" />
				<input type="text" name="lastname" id="lastNameBox" class="logintextbox shortloginbox" placeholder="Last" value="" onkeypress="if (event.keyCode==13) { event.preventDefault(); validateInputs(); }" />
			...
			<span class="loginlabel" >Email</span>
				<input type="text" name="email" id="emailBox" class="logintextbox" value="" onkeypress="if (event.keyCode==13) { event.preventDefault(); validateInputs(); }" />
			...
			<span class="loginlabel" >Profile Picture URL (optional)</span>
				<input type="text" name="profilepic" id="profilePicBox" class="logintextbox" value="" onkeypress="if (event.keyCode==13) { event.preventDefault(); validateInputs(); }" />
				<span class="errorMsg" id="picInvalidChars">URL may only contain a-z A-Z 0-9 . _ / : ? = + -</span>
				
			<div class="spacer"> </div>

			<span class="loginlabel" >Password </span>
				<input type="password" id="pwdBox" name="password" class="logintextbox" value="" onkeypress="if (event.keyCode==13) { event.preventDefault(); validateInputs(); }" > 

			<span class="loginlabel" >Confirm password</span>
				<input type="password" id="confirmPwdBox" name="confirmpassword" class="logintextbox" value="" onkeypress="if (event.keyCode==13) { event.preventDefault(); validateInputs(); }" > 
